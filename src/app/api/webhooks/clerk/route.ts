...
export async function POST(req: Request) {
  ...
  const user = {
  id: 0, // Assign a default value if `id` is auto-generated by your database
  apiKey: 123456, // Replace with a proper value if applicable
  clerkId,
  email: email_addresses[0]?.email_address || "",
  firstName: first_name || "Unknown",
  lastName: last_name || "Unknown",
  role: "USER" as Role, // Cast to `Role` type if necessary
  createdAt: new Date(),
  updatedAt: new Date(),
};
